     ...
     case '/cap':{
      ...
      case '/kaji':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/kaji.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/amgs':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/amgs.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/kill':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/kill.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/report':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/report.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/alarm':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/alarm.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/cares':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/cares.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/bara':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/bara.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/cringe':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/cringe.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/directed':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/directed.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }
      ...
      case '/sike':{
        if (message.member.voice.channel) {
          ...
          const connection = await message.member.voice.channel.join();
          //message.channel.send(attachment);
          const dispatcher = connection.play('./record/sike.mp3');
        } else {
          message.reply('a coglione entra in vocale per farlo');
        }
      }*/
